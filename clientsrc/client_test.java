...
public class client_test
{
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        obj.runCmd(obj,outToServer,inFromServer, "newcar,1,A,1,1");
        obj.runCmd(obj,outToServer,inFromServer, "newcar,1,B,2,2");
        obj.runCmd(obj,outToServer,inFromServer, "newcar,1,C,3,3");
        obj.runCmd(obj,outToServer,inFromServer, "newcar,1,D,4,4");

        obj.runCmd(obj,outToServer,inFromServer, "newroom,1,A,1,1");
        obj.runCmd(obj,outToServer,inFromServer, "newroom,1,B,2,2");
        obj.runCmd(obj,outToServer,inFromServer, "newroom,1,C,3,3");
        obj.runCmd(obj,outToServer,inFromServer, "newroom,1,D,4,4");
                
        obj.runCmd(obj,outToServer,inFromServer, "newflight,1,1,1,1");
        obj.runCmd(obj,outToServer,inFromServer, "newflight,1,2,2,2");
        obj.runCmd(obj,outToServer,inFromServer, "newflight,1,3,3,3");
        obj.runCmd(obj,outToServer,inFromServer, "newflight,1,4,4,4");

        obj.runCmd(obj,outToServer,inFromServer, "newcustomerid,1,111");
        obj.runCmd(obj,outToServer,inFromServer, "newcustomerid,1,222");

        obj.runCmd(obj,outToServer,inFromServer, "deletecar,1,A");
        obj.runCmd(obj,outToServer,inFromServer, "deletecar,1,E");

        obj.runCmd(obj,outToServer,inFromServer, "deleteroom,1,A");
        obj.runCmd(obj,outToServer,inFromServer, "deleteroom,1,E");

        obj.runCmd(obj,outToServer,inFromServer, "deleteflight,1,1");
        obj.runCmd(obj,outToServer,inFromServer, "deleteflight,1,5");

        obj.runCmd(obj,outToServer,inFromServer, "reserveflight,1,111,1");
        obj.runCmd(obj,outToServer,inFromServer, "reserveflight,1,111,2");
        obj.runCmd(obj,outToServer,inFromServer, "reserveflight,1,111,5");

        obj.runCmd(obj,outToServer,inFromServer, "reservecar,1,111,A");
        obj.runCmd(obj,outToServer,inFromServer, "reservecar,1,111,B");
        obj.runCmd(obj,outToServer,inFromServer, "reservecar,1,111,E");

        obj.runCmd(obj,outToServer,inFromServer, "reserveroom,1,111,A");
        obj.runCmd(obj,outToServer,inFromServer, "reserveroom,1,111,B");
        obj.runCmd(obj,outToServer,inFromServer, "reserveroom,1,111,E");

        obj.runCmd(obj,outToServer,inFromServer, "deletecustomer,1,111");

        obj.runCmd(obj,outToServer,inFromServer, "itinerary,1,222,1,2,3,4,B,true,false");
        obj.runCmd(obj,outToServer,inFromServer, "itinerary,1,222,2,2,4,2,B,true,false");
        obj.runCmd(obj,outToServer,inFromServer, "itinerary,1,222,2,3,4,2,4,B,true,false");
        
        obj.runCmd(obj,outToServer,inFromServer, "quit");
    }
    public void megaQuery(client_test obj, ObjectOutputStream outToServer,BufferedReader inFromServer)
    {
        System.out.println();
            try{
                System.out.println();
                ...
                for (int i = 1; i<=4; i++) {
                    ...
                    if (i == 4)
                        loc = "D";
                    command="querycar,1,"+loc;
                    arguments=obj.parse(command);
                    outToServer.writeObject(arguments);
                    String seats=inFromServer.readLine();
                    command="querycarprice,1,"+loc;
                    arguments=obj.parse(command);
                    outToServer.writeObject(arguments);
                    String price=inFromServer.readLine();
                ...
                for (int i = 1; i<=4; i++) {
                    ...
                    if (i == 4)
                        loc = "D";
                    command="queryroom,1,"+loc;
                    arguments=obj.parse(command);
                    outToServer.writeObject(arguments);
                    String seats=inFromServer.readLine();
                    command="queryroomprice,1,"+loc;
                    arguments=obj.parse(command);
                    outToServer.writeObject(arguments);
                    String price=inFromServer.readLine();
    ...
    public void runCmd(client_test obj,  ObjectOutputStream outToServer,BufferedReader inFromServer, String command)
    {
        BufferedReader stdin = new BufferedReader(new InputStreamReader(System.in));
        Vector arguments  = new Vector();
        int Id, Cid;
