...
public class MiddleWareImpl
{
    ...
    public static void main(String args[]) throws IOException {
        ...
        String server_flight="local_host";
        String server_car="local_host";
        String server_room="local_host";
        if (args.length == 3){
        ...
        if (args.length < 3){
            System.out.println("Usage: java MidImpl.MiddleWareImpl [flgiht server] [car server] [room server]");
            System.exit(1);
            }
        try
        {
            rm_server.runServerThread(rm_server, server_flight, server_car, server_room);
        }
        catch (Exception e)
        {
    ...
    public void runServerThread(MiddleWareImpl rm_server, String server_flgiht, String server_car, String server_room) throws IOException
    {
